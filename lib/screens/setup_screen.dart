...
class _AutoGenerateDialogState extends State<_AutoGenerateDialog> {
  ...
  void _generate() {
    final levels = StructureGenerator.generate(StructureGeneratorOptions(
      hasAnte: _hasAnte,
  ...
  @override
  Widget build(BuildContext context) {
    final preview = StructureGenerator.generate(StructureGeneratorOptions(
      hasAnte: _hasAnte,
      startChips: _startChips,
      minChip: _minChip,
      playTime: _playTime,
        ...
        children: [
          Row(
            children: [
              ...
              const SizedBox(width: 6),
              Text(
                'Preview — ${levels.length} levels × ${levelDuration}m',
